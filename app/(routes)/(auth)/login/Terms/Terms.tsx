...
const Terms = () => {
  ...
  return (
    <div className="text-xs mt-4 mb-10 text-gray-600 max-w-72" >
        <div className="mb-5">
            <span>
                Esta página utiliza Google reCATCHA para verificar que no eres un robot.
            </span>
            <Button variant="ghost" onClick={()=>setShowExtraTerms(!showExtraTerms)} className="opacity-80 text-[#0071eb] hover:bg-transparent p-0 ml-1 h-fit">Mas información</Button>
        </div>
        <div className="h-28">
            ...
            utiliza para publicidad personalizada).</p>}
        </div>
    </div>
  )
}
